<template>
    ...
    <el-form ref="formName" :model="form" label-width="150px" :rules="rules">
      ...
      <el-form-item label="客户名称：" prop="name">
        <el-input 
          v-model="form.name" 
          placeholder="字数长度1~30以内"
          @blur="checkName(form.name)"
          validate-event
          ></el-input>
      </el-form-item>
      ...
      <div  v-if="form.type!=3" >
        <el-form-item label="客户办公地址：" prop="parentCustomer">
          <div class="address-box">
            <el-form-item prop="provinceName">
              <el-select v-model="form.provinceName" placeholder="选择省/直辖市" @change="onProvincesChange">
                <el-option
            ...
            <el-form-item  prop="cityName" class="addressBox">
              <el-select v-model="form.cityName" placeholder="选择城市" @change="onCityChange">
                <el-option
            ...
            <el-form-item prop="countyName" class="addressBox" >
              <el-select v-model="form.countyName" placeholder="选择区/县" @change="onCountyChange">
                <el-option
        ...
        <el-form-item label="详情地址：" label-width="150px" prop="addressLine">
          <el-input type="textarea"  v-model="form.addressLine"  placeholder="详细地址，请输入200字以内" class="address-textarea"></el-input>   
        </el-form-item>
      </div>
      <el-form-item label="客户联系人：">
        <el-form-item  class="el-input-three" prop="contactName">
          <el-input v-model="form.contactName" class="contact" placeholder="字数长度1~15以内">
          </el-input>
        </el-form-item>
        <el-form-item  prop="contactPhone" label="联系方式：" class="el-input-three" style="width:46%">
          <el-input v-model="form.contactPhone" class="contact"  placeholder="字数长度1~15以内">
         </el-input>
        </el-form-item>
      </el-form-item>
      <el-form-item label="业务员账号："  required >
          ...
          <el-form-item label="业务员姓名：" prop="userDataAuthorityName" class="el-input-three " style="width:46%">
            <el-input v-model="realName" style="width: 100%;" disabled placeholder="通过账号直接关联人名"></el-input>
          </el-form-item>
      </el-form-item>
      <el-form-item class="form-button-box">
        <el-button type="primary" @click="addTargetCustomer('formName')" class="form-button">保存</el-button>
...
import {addTargetCustomer,addCheckRepeat,industryTree,simpleList,getOrganizationInfo} from '@/api/targetCustomerManage';
  ...
  data() {
    ...
    return {
      ...
      rules:{
        ...
        contactName:[{ min: 1, max: 15, message: '长度在 1 到 15 个字符', trigger: 'blur' }]
      },
    }
  },
  created() {
            ...
            this.$refs[formName].validate((valid) => {
                  if(valid) {
                        addTargetCustomer({
                          ...
                          customerContactName:this.form.contactName,
                          customerContactPhone:this.form.contactPhone,
                          ...
                          if(res.code=='000000'){
                            ...
                            this.close({name:'AddTargetCustomer', to: {name:'TargetCustomer', params:{isUpdate:true}}}); 
                          }
                        })
                  } else {
                    return false;
