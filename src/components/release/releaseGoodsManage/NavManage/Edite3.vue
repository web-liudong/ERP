...
<script>
  ...
  import {editingDetail3,editNavigation} from '@/api/release/navManage'
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id){
        editingDetail3(id).then(res=>{
          if(res.code=='000000'){
            this.form.name1 = res.data.firstLevelName
            this.form.name2 = res.data.secondLevelName
            this.form.name3 = res.data.name
