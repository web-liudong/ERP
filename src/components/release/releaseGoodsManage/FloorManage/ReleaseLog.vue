  ...
  <div class="wrapper">
    <div class="form">
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="userInfo.realName" label="操作者" width="258" align="center"></el-table-column>
        <el-table-column prop="operationTime" label="操作时间" align="center"></el-table-column>
        <el-table-column label="发布内容预览" align="center">
          <template slot-scope="scope">
            <el-button type="text" size="small" @click="findDetail(scope.row.id)">查看</el-button>
          </template>
        </el-table-column>
        <el-table-column label="发布结果" align="center">
          <template slot-scope="scope">
...
<script>
import { releaseLog, releaseHistory } from "@/api/release/floorManage";
export default {
  name: "releaselog",
  data() {
    return {
