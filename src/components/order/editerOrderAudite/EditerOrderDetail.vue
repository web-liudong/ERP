    ...
    <div class="detaillTable2 clear">
      ...
      <el-table :data="goodsList" border style="width:90%;" size="small">
        ...
        <el-table-column prop="skuName" label="商品名称" style="width: 33%" align="center">
           <template slot="header"><span> <i style="color:red">*</i> 商品名称</span></template>  
        </el-table-column>
        ...
        <el-table-column prop="description" label="小计" style="width: 33%" align="center">
          <template slot-scope="scope">
              ￥{{scope.row.currentPrice*scope.row.itemQty}}
            </template>  
        </el-table-column>
      ...
      <div class="button-box">
          ...
          <el-button type="primary" @click="toReject({'id':tableData.id})">审核驳回</el-button> -->
...
import { getEditerOrderDetail,auditerPass,auditerNoPass } from "@/api/ordernodraft.js";
    ...
    toAudite(){
        auditerPass(this.orderId).then(res=>{
            if(res.code=='000000'){
             ...
             setTimeout(()=>{
              this.close({name:'EditerOrderDetail'});
             },1000)
            }
        })
    },
