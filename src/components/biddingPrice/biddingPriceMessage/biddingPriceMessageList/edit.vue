  ...
  export default {
    ...
    methods: {
      editEchoBiddingPriceInfo(){
        ...
        editEchoBiddingPriceInfo(this.biddingId).then(res=>{
          if(res.code=='000000'){
            this.form=res.data;
            ...
            editBiddingPriceInfo(this.biddingId,this.form).then(res=>{
              if(res.code=='000000'){
                ...
                this.$refs[formName].clearValidate();
                 this.timeout = setTimeout(() => {
                    this.close({name:'biddingPriceMessageEdit', to: {name:'biddingPriceMessageList', params:{isUpdate:true}}}); 
                  }, 3000 * Math.random());
              ...
              }else if(rej.response.data.code=='010210011'){
