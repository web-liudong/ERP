    ...
    <div class="redactTable">
      ...
      <el-form :model="addData" :rules="rules" ref="ruleForm" label-width="150px">
        ...
        <el-form-item>
          ...
          <el-button type="primary"  v-if="$authorities.AccreditCreate" @click="submitForm('ruleForm')">提交保存</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
      ...
      postAccreditAdd(data) {
        postAccreditAdd(
          ...
          if (res.code == '000000') {
            ...
            this.close({name:'AccreditAdd', to: {name:'Accredit', params:{isUpdate:true}}});
          } else {
            this.$message({
              message: res.message,
              type: 'warning',
