  ...
  <div class="addSecond">
    <div class="footerBox">
      ...
      <el-form :model="form" ref="form" label-width="150px" class="demo-dynamic" :rules="rules">
        ...
        <el-form-item required prop="parentName" label="所属一级分类：">
          <el-input v-model="form.parentName" readonly class="parent-name"></el-input>
        </el-form-item>
    ...
    update() {
      ...
      update2(that.id, {
        ...
        if (res.code == "000000") {
          ...
          this.close({
            name: "CategoryUpdate2",
            to: { name: "Category2", params: { isUpdate: true } }
          });
        } else {
          this.$message({
            message: "操作失败",
