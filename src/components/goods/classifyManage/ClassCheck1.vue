...
import { reviewPass, reviewReject, detail, getstatus } from "@/api/classManage";
export default {
  inject: ["reload", "close"],
  name:'CategoryCheck1',
  data() {
            ...
            if (res.data == 1) {
              reviewReject(this.id, {
                ...
                if (res.code == "000000" && res.data == 1) {
                  ...
                  this.close({name:'CategoryCheck1', to: {name:'Category1', params:{isUpdate:true}}});
                }
              });
            } else {
              this.$alert(
